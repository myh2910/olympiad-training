...
\begin{probMR}[High-School Mathematics 1994/1, China \cite{ref:titu-102}]
	Determine cuantos subconjuntos de $\{1,2,\dots,2000\}$ tienen suma de elemento múltiplo de $5$.\footnote{Por casualidad vi un video de 3Blue1Brown cubriendo este problema: \url{https://www.youtube.com/watch?v=bOXCLR3Wric}.}
	\begin{hint}
...
\begin{probEG}[IMO Shortlist 2001/N1]
...
\begin{probMR}[IMO Shortlist 2001/N3]
...
\begin{problem}[IMO Shortlist 2001/N4]
...
\begin{problem}[IMO Shortlist 2001/N5]
	Let $a>b>c>d$ be positive integers and suppose
	\[ac+bd=(b+d+a-c)(b+d-a+c).\]
	Prove that $ab+cd$ is not prime.
\end{problem}

\begin{problem}[IMO Shortlist 2001/N6]
